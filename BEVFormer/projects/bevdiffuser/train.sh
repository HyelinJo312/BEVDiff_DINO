...
PRETRAINED_UNET_CHECKPOINT="../../train/BEVDiffuser_BEVFormer_tiny_original/checkpoint-30000"
# PRETRAINED_UNET_CHECKPOINT=None

# set up wandb project
PROJ_NAME=BEVDiffuser
RUN_NAME=BEVDiffuser_BEVFormer_tiny_pretraining_scratch_concat_customlr_trained-unet
